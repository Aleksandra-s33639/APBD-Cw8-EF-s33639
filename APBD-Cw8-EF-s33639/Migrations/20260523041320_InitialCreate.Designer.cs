...
namespace APBD_Cw8_EF_s33639.Migrations
{
    ...
    [Migration("20260523041320_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.Pc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.PcComponent", b =>
                {
                    b.Property<int>("PcId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.Component", b =>
                {
                    b.HasOne("APBD_Cw8_EF_s33639.Models.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_Cw8_EF_s33639.Models.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("APBD_Cw8_EF_s33639.Models.PcComponent", b =>
                {
                    b.HasOne("APBD_Cw8_EF_s33639.Models.Component", "Component")
                        .WithMany("PcComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_Cw8_EF_s33639.Models.Pc", "Pc")
                        .WithMany("PcComponents")
                        .HasForeignKey("PcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
